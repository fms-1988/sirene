...
def coefficients(self):
    ...
    if self.emission =='total':
    ...
    elif self.emission =='agriculture':
      ...
      print("You must choose 'emission' as one of the following: 'energia', 'residuo', 'agriculture', 'ippu', 'lulucf', 'total', or 'total_no_lulucf'.")
...
def read(sector='agriculture',gas='CO2'):
  #File Path
